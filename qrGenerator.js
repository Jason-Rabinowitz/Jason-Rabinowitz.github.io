function generateQRPython() {
    ...
    var qrcode = new QRCode("qrCode", "https://jason-rabinowitz.github.io/logStudent.html?username="+document.getElementById("username").value+"&userID="+document.getElementById("userID").value+"&eventName="+document.getElementById("event").value);
